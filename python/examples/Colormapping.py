...
def rotate_gradient(strip, img_gradient, speed):
    bright = 255
    col_map_old = []
    for k in range(0, LED_COUNT):
        col_map_old = shift(img_gradient, k)
...
#         print("old: " + str(col_map_old[0]) + ", new: " + str(col_map_new[0]))
        fade_gradient(strip, col_map_new, col_map_old, speed*100)
...
#             print ('gradient_list(' + str(i) + ') now playing')
            ...
            for map_counter, c_map in enumerate(color_maps_li):
                ...
                fade_gradient(strip, gradient_map_original, color_maps_li[map_counter], speed)
                rotate_gradient(strip, color_maps_li[map_counter], speed)
                fade_gradient(strip, color_maps_li[map_counter], gradient_map_original, speed)
#             i =+ 1
